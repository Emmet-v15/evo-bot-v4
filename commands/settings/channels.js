...
module.exports = {
    ...
    execute: async(client, interaction) => {
        ...
        if (channel) {
            ...
            interaction.editReply({ content: `The ${cat} channel is currently <#${client.settings.get(interaction.guild.id, `${cat}.channel`)}>` });
        }
    },
    options: [
        { type: "String", name: "category", description: "The specified category", required: true, choices: { logs: "logs"} },
